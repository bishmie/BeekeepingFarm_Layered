...
public void initializer(){
    ...
    private int getTotalRevenue() throws SQLException, ClassNotFoundException {
        return orderBO.getTotalRevenue();
    ...
    private int getTodayOrderCount() throws SQLException, ClassNotFoundException {
           return orderBO.getTodayOrderCount();
    ...
    private int getOrderCount() throws SQLException {
        try {
            return orderBO.getTotalOrderCount();
        } catch (ClassNotFoundException e) {
            throw new RuntimeException(e);
        }
    ...
    private int getSupplierCount() throws SQLException, ClassNotFoundException {
        return supplierBO.getSupplierCount();
    ...
    private int getCustomerCount() throws SQLException, ClassNotFoundException {
        return customerBO.getAllCustomerCount();
